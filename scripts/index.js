const ready = () => {
  ...
  const mainBodyShrinkSize = menuToggleSizes.x * 2 + menuToggleSizes.width;
  sideDrawer.style.width = bodySizes.width - mainBodyShrinkSize + 'px';
  ...
  const menuToggleClickHandler = () => {
    backdrop.classList.add('smooth-animation');
    mainBody.classList.add('smooth-animation');
